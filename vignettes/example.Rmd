...
For further plots being created in this vignette, a minimal theme will be set:
...
This example demonstrates how to plot the routes taken by each driver, overliad with the intended route. This is useful for explaining how the laps worked, as well as for identifying deviations from the intended route.
...
### Calculating brake variability on black ice per lap, per driver

This example demonstrates a method for calculating variance in the brake use during the black ice event, for each lap, for each driver.
