...
Assuming the log files are structured appropriately, read the data into R as follows:
...
By using `read_all()`, you have imported the data as a list object, with some a number of useful things happening automatically for you. For example:
...
The important thing to understand is the structure of this list, `d`.
