...
This will open an internet browser with a list of the available vignettes (including this one). In general, the first vignette you should read is "Reading log files", which you can open by clicking the "HTML" link. This vignette explains how to structure a directory of simulation-generated log files and read them into R.
