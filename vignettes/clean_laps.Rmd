...
Cleaning requires user log files to have been read into R in the appropriate format. For details about how to read in log files so that they can be cleaned using adapter functions, please read the [Vignette on Reading log files](read_logs.html).
